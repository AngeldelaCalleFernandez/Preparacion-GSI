...
## 5.3 Microhecho oficial y actualización 2026

## ISO/IEC/IEEE 12207 define un marco común para los procesos del ciclo de vida del software. La OEP 2022 preguntó directamente por “ISO 12207”. La edición vigente es ISO/IEC/IEEE 12207:2026, publicada en abril de 2026, y sustituye a ISO/IEC/IEEE 12207:2017. Comprende procesos a lo largo de adquisición/suministro, desarrollo, operación, mantenimiento y retirada. Trampa: la respuesta de la pregunta histórica sigue siendo “ISO 12207”; no memorices 2017 como edición vigente.
...
## 6.7 Microhechos oficiales de diseño y concurrencia

## ANSI/SPARC distingue los niveles externo, conceptual e interno.

## Entidad débil: su existencia o identificación depende de una entidad propietaria; superclave = uno o más atributos que identifican unívocamente una tupla, y clave candidata = superclave mínima.

## READ COMMITTED impide lecturas sucias; puede permitir lecturas no repetibles y fantasmas según el modelo estándar.

## Una PK no admite NULL. UNIQUE y el tratamiento de NULL dependen del SGBD. ON DELETE RESTRICT impide borrar la fila padre mientras existan referencias hijas.
...
## 6.5 Microhechos oficiales de estructuras e IA

## Una pila es la estructura clásica para evaluar expresiones en notación postfija.

## Recorridos de árbol: preorden = raíz → izquierda → derecha; inorden = izquierda → raíz → derecha; postorden = izquierda → derecha → raíz.

## MLOps: una buena métrica offline no basta; hay que monitorizar rendimiento en producción y drift de datos o concepto. Reentrenar automáticamente sin esa realimentación puede degradar el servicio.

## Presidio es una herramienta para detectar y anonimizar o redactar información personal identificable (PII); en la OEP 2025 aparece como “Microsoft Presidio”.
...
## 11.6 Herramientas y prácticas preguntadas oficialmente

## YAML es un formato/lenguaje de serialización de datos legible por humanos, muy usado en configuración y automatización.

## Jenkins es un servidor de automatización open source escrito en Java, habitual en integración continua.

## Maven gestiona construcción y dependencias de proyectos Java y usa un POM definido en XML.

## Docs as Code: documentación versionada junto al código, revisión por pull request y generación o validación automatizable dentro del pipeline CI/CD.
...
## 11.10 Herramientas y técnicas preguntadas oficialmente

## Fuzzing introduce entradas aleatorias, inválidas o malformadas para descubrir fallos.

## Selenium automatiza pruebas de aplicaciones web o navegadores; Cucumber soporta BDD; JUnit es un framework de pruebas del ecosistema Java.

## Las pruebas de aceptación validan necesidades y criterios de negocio con participación de usuarios o representantes del negocio; no son equivalentes a pruebas unitarias o de sistema.
...
## 8.7 Microhechos Java preguntados oficialmente

## volatile mejora la visibilidad y el orden de accesos entre hilos, pero no vuelve atómicas las operaciones compuestas.

## javac compila código fuente Java. Bouncy Castle es una biblioteca/proveedor criptográfico del ecosistema Java.

## JAAS sigue existiendo en Java SE actual: LoginModule define initialize, login, commit, abort y logout. No confundir JAAS (Java SE) con Jakarta Security.
...
**Base A1: 066 (2023), útil para CLR, bibliotecas, ADO.NET, EF y LINQ. Actualización oficial: política de soporte Microsoft actualizada el 08/09/2026: .NET 10 LTS activo hasta 14/11/2028; .NET 9 STS y .NET 8 LTS hasta 10/11/2026. No estudiar .NET 6 como “LTS vigente”.**
...
## 8.8 Soporte y términos de examen

## Según la política oficial de Microsoft actualizada el 08/09/2026: .NET 10 es LTS y finaliza soporte el 14/11/2028; .NET 9 (STS) y .NET 8 (LTS) finalizan soporte el 10/11/2026.

## CLI = Common Language Infrastructure, especificación común sobre la que se apoyan runtimes y lenguajes .NET.

## “LINQ to Entities” es terminología de Entity Framework clásico para consultar el modelo conceptual mediante LINQ; en .NET moderno el foco es EF Core + LINQ, pero la expresión sigue siendo preguntable como legado.
...
## 8.8 Microhechos oficiales de protocolos y formatos

## HTTP/2 usa framing binario y permite multiplexar o intercalar múltiples streams de petición/respuesta sobre una misma conexión.

## JSON se apoya en objetos con pares nombre/valor y arrays ordenados; no usa etiquetas y atributos como XML.

## WSDL describe interfaces o contratos de servicios web. UDDI sirve para registro, publicación y descubrimiento de servicios y hoy debe estudiarse como tecnología legacy.

## REST: cliente/servidor, sin estado, cacheable, interfaz uniforme y sistema por capas.
...
## 8.9 Declaración de accesibilidad: literal rentable

## RD 1112/2018, art. 15: la declaración debe ser detallada, exhaustiva y clara, y actualizarse como mínimo una vez al año o cada vez que se realice una revisión de accesibilidad.

## Debe incluir, entre otros elementos, las partes no accesibles y sus razones o alternativas, el mecanismo de comunicación y el enlace al procedimiento de reclamación.

## Un lector de pantalla es tecnología de asistencia especialmente relevante para personas con discapacidad visual. Accesible significa que las personas pueden percibir, operar o navegar, entender e interactuar con el contenido; no equivale a que sea simplemente atractivo o rápido.
...
* Microsoft .NET Support Policy, actualizada 08/09/2026: .NET 10 LTS activo hasta 14/11/2028; .NET 9 STS y .NET 8 LTS hasta 10/11/2026.
...
Auditoría cerrada: 23/09/2026.

Corpus: OEP 2018, 2019, 2022 y 2024 con plantilla definitiva; OEP 2025 con plantilla provisional. Criterio: pregunta oficial → cobertura literal/conceptual en V2.1 → vigencia en 2026. No se incorpora una tecnología solo por haber aparecido históricamente si está retirada o el dato era puramente de versión.

Cambio 01 — III.01. ISO/IEC/IEEE 12207:2026: edición vigente; sustituye a 12207:2017. Evidencia: OEP 2022 Q39.

Cambio 02 — III.02. Kanban, Planning Poker, Sprint Goal, Gantt y PERT. Evidencia: 2018 Q40-Q41; 2019 Q40-Q42; 2024 Q51; 2025 Q43/Q48/Q49 (provisional).

Cambio 03 — III.03. Sin cambio: V2.1 ya cubre verificabilidad, prototipos e ISO/IEC/IEEE 29148. IEEE 830 queda solo como antecedente histórico de OEP 2019 Q44.

Cambio 04 — III.04. ANSI/SPARC, entidad débil/superclave, READ COMMITTED, PK/UNIQUE/RESTRICT. Evidencia: 2018 Q45-Q47; 2019 Q47-Q48; 2022 Q45-Q47; 2025 Q51-Q53 (provisional).

Cambio 05 — III.05. Pila/postfija, recorridos de árbol, MLOps y Presidio. Evidencia: 2018 Q49; 2025 Q55-Q58 (provisional).

Cambio 06 — III.06. YAML, Jenkins, Maven y Docs as Code. Evidencia: 2018 Q50; 2019 Q52-Q53; 2024 Q55-Q56; 2025 Q57 (provisional).

Cambio 07 — III.07. Fuzzing, Selenium, Cucumber, JUnit y aceptación. Evidencia: 2018 Q51-Q53; 2019 Q54-Q55; 2024 Q57-Q58; 2025 Q68 (provisional).

Cambio 08 — III.08. MÉTRICA v3: MSI correctivo/evolutivo; adaptativo/perfectivo fuera de ámbito. Evidencia: OEP 2024 Q60 y documentación MÉTRICA.

Cambio 09 — III.09. Diagramas UML de interacción y dependencia; Observer. Evidencia: 2018 Q55-Q56; 2019 Q57-Q58; 2022 Q55-Q56.

Cambio 10 — III.10. volatile, javac/Bouncy Castle y JAAS LoginModule. Evidencia: 2018 Q57-Q58; 2025 Q62-Q63 (provisional); vigencia comprobada en Java SE actual.

Cambio 11 — III.11. Fechas .NET 8/9/10, CLI y LINQ to Entities. Evidencia: 2022 Q59-Q60; 2025 Q59/Q64-Q65 (provisional); política Microsoft 08/09/2026.

Cambio 12 — III.12. HTTP/2, JSON, WSDL, UDDI y REST. Evidencia: 2018 Q63; 2019 Q64; 2022 Q61-Q62; 2024 Q66; 2025 Q66-Q67 (provisional).

Cambio 13 — III.13. GQM, puntos de función, CMMI y tolerancia a fallos. Evidencia: 2019 Q65; 2022 Q63-Q64; 2024 Q67-Q68; 2025 Q69 (provisional).

Cambio 14 — III.14. Literal rentable del art. 15 RD 1112/2018 y tecnología asistiva. Evidencia: 2019 Q66; 2022 Q65; 2024 Q69-Q70; 2025 Q70-Q72 (provisional).

Cambio 15 — III.15. Sharding/BSON, Spark, validación cruzada y Neo4j. Evidencia: 2018 Q68-Q69; 2019 Q68-Q69; 2022 Q67-Q68; 2024 Q71-Q72; 2025 Q73 (provisional).

Exclusiones deliberadas por obsolescencia o baja rentabilidad: Hibernate OGM (OEP 2018 Q59) no se incorpora como tecnología actual; Xamarin (OEP 2019 Q61) no se incorpora como plataforma vigente; versiones puntuales como Visual Studio 2019 y detalles visuales de guías antiguas no se fijan como conocimiento actual; preguntas anuladas no generan ampliación; certificaciones o productos puntuales sin valor conceptual estable no amplían el tema.
