...
* 18: honor, intimidad, propia imagen, inviolabilidad del domicilio y secreto de comunicaciones.
...
Se regula en el **Título II**. El Rey es Jefe del Estado, símbolo de unidad y permanencia y arbitra/modera el funcionamiento regular de las instituciones. Su persona es **inviolable y no está sujeta a responsabilidad**. Sus actos están sujetos a **refrendo** salvo excepciones constitucionales relativas a su Casa.
...
* funciones internacionales constitucionales.
...
La LO 3/2007 busca hacer efectivo el derecho de igualdad de trato y oportunidades.
...
La respuesta es **integral**, no exclusivamente penal: prevención/sensibilización, educación, publicidad, sanidad, derechos laborales/económicos, asistencia social, tutela institucional, judicial y penal.
...
Establece medidas de igualdad real/efectiva de personas trans y garantía de derechos LGTBI. Para GSI: no discriminación, políticas públicas, empleo/servicios, tratamiento respetuoso de identidad y confidencialidad/protección de datos.
...
La Ley articula el Sistema para la Autonomía y Atención a la Dependencia, servicios/prestaciones y reconocimiento de situación.
...
* seudonimización → reduce vinculación directa, pero sigue siendo dato personal si puede reidentificarse.
...
En AAPP son frecuentes obligación legal e interés público/poderes públicos.
...
Supresión ≠ derecho al olvido en todos los contextos; oposición ≠ revocar consentimiento; portabilidad ≠ mera copia documental.
...
Puede actuarse por representante. Para determinados actos debe acreditarse; para actos de mero trámite se presume. El **apoderamiento apud acta** puede ser presencial o electrónico y los registros electrónicos de apoderamientos facilitan su gestión.

## 3. Derechos y relación electrónica

Entre los derechos: comunicarse mediante PAGe, asistencia en medios electrónicos, uso de lenguas oficiales, acceso a información/archivos conforme a normativa, trato respetuoso, exigir responsabilidades y protección de datos.
...
* terminación convencional cuando proceda.
...
Autoridades/personal deben abstenerse ante causas de interés/conflicto previstas. Interesados pueden recusar. Un sistema de expedientes debe poder **reasignar**, registrar causa y dejar trazabilidad.
...
Servicios típicos: trámites, registro, identificación/firma, consulta de estado, notificaciones, verificación, calendario/hora oficial y tablón cuando proceda.
...
Conjunto ordenado de documentos y actuaciones correspondientes a un procedimiento. Incluye índice electrónico y garantías de integridad.
...
Las copias auténticas deben seguir procesos/competencias previstos y conservar relación con original. La digitalización transforma documentos en papel a documentos electrónicos con garantías cuando proceda.
...
**Importante:** dato abierto no significa “todo dato de la Administración debe publicarse”. Existen exclusiones/límites por datos personales, seguridad, propiedad intelectual, confidencialidad y demás normativa.
...
Áreas: - estándares; - redes/servicios; - firma/certificados; - documento/expediente; - conservación; - reutilización; - modelos de datos; - política de gestión documental.
...
Existen guías especializadas para nube, VPN, móviles, Wi-Fi, malware y registro. Para GSI interesa conocer familias/conceptos, no cientos de números sin contexto.
...
El **RD 1125/2024** actualiza organización e instrumentos operativos para Administración Digital de la Administración del Estado y el marco de medios/servicios transversales.
...
Aplicación de firma en el entorno del usuario.

### FIRe

Facilita integración de mecanismos de firma locales/en nube mediante componente común.
...
La **Dirección Electrónica Habilitada única** actúa como punto de acceso a notificaciones/comunicaciones electrónicas en el ámbito correspondiente.
...
No es una “base de datos única del ciudadano”; integra información de sistemas diferentes.
