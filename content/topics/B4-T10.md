...
<!-- editorial-supplement:B4-T10:01:start -->

### Mensajes clásicos OSPFv2 y básicos BGP-4

OSPFv2 (RFC 2328) define cinco tipos clásicos de paquete: Hello, Database Description, Link State Request, Link State Update y Link State Acknowledgment. Hello descubre y mantiene vecinos; descripción y solicitud ayudan a sincronizar la base de estado de enlace; Update transporta LSA y Acknowledgment confirma su recepción.

BGP-4 (RFC 4271) define cuatro tipos básicos de mensaje: OPEN, UPDATE, NOTIFICATION y KEEPALIVE. Route Refresh está definido separadamente por RFC 2918, que es anterior a RFC 4271; por tanto, no debe afirmarse que en el ecosistema BGP actual solo puedan existir esos cuatro tipos.

<!-- editorial-supplement:B4-T10:01:end -->
