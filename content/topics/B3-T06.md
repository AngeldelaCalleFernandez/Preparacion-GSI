...
Fuente: [03 — BLOQUE III — Desarrollo de sistemas — GSI A2](https://docs.google.com/document/d/1T28bNfTrftG0eCG2sX336DKKir-8ruVKnkhKMS0w7N0/edit) · III.06 · V2.1 · 2026-09-23
...
### Pipeline trazable desde el código hasta la operación

![Pipeline de integración y entrega con commit, build reproducible, pruebas, análisis de seguridad, artefacto firmado, promoción por entornos, despliegue progresivo, observabilidad, documentación y formación.](../../assets/diagrams/b3/b3-t06-pipeline-entrega.svg)

_Integra construcción, calidad, despliegue y transferencia de conocimiento._

**Qué debes recordar:** Se promueve el mismo artefacto inmutable; Continuous Delivery conserva una decisión de despliegue y Continuous Deployment la automatiza.
...
La construcción abarca herramientas, dependencias, generación de código, pruebas, empaquetado y promoción del mismo artefacto, junto con documentación y formación para operar el sistema.
