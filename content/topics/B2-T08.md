...
Fuente: [02 — BLOQUE II — Tecnología básica — GSI A2](https://docs.google.com/document/d/1_-6JFktfHXhth_n3KeUfRPjPeFxp3Mgkl2HlZzab7c4/edit) · II.08 · V2.1 · 2026-09-23
...
### Correspondencia OSI, TCP/IP y encapsulación

![Comparación vertical de las siete capas OSI con las cuatro capas TCP/IP y la encapsulación datos, segmento o datagrama, paquete IP, trama y bits, incluyendo ejemplos de protocolos y equipos.](../../assets/diagrams/b2/b2-t08-osi-tcpip.svg)

_Une función, modelo y PDU en una sola lectura para resolver preguntas de capas._

**Qué debes recordar:** TCP/IP agrupa sesión y presentación dentro de aplicación; transporte usa puertos, red usa IP y enlace trabaja con tramas y MAC.
