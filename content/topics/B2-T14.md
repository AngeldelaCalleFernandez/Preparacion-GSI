...
Fuente: [02 — BLOQUE II — Tecnología básica — GSI A2](https://docs.google.com/document/d/1_-6JFktfHXhth_n3KeUfRPjPeFxp3Mgkl2HlZzab7c4/edit) · II.14 · V2.1 · 2026-09-23

## 1. Alcance del tema

El tema combina software libre y propietario, familias de licencias, protección jurídica de programas y medidas técnicas de protección. Deben separarse libertad, precio, titularidad, licencia y DRM.
...
### Licencias de software: permisos y obligaciones

![Comparación entre software propietario, licencias permisivas y copyleft, con ejemplos MIT, BSD, Apache, LGPL, GPL, AGPL y EUPL y diferencias frente a dominio público y DRM.](../../assets/diagrams/b2/b2-t14-licencias.svg)

_Ordena las familias por condiciones de reutilización sin confundir licencia jurídica con mecanismo técnico._

**Qué debes recordar:** Libre no significa gratis; permisiva no significa sin condiciones; copyleft no es dominio público y DRM no es una licencia.
