...
<!-- editorial-supplement:B2-T07:01:start -->

### Actualización comprobada de Kubernetes

A 22/09/2026, el proyecto Kubernetes mantiene las ramas menores 1.37, 1.36 y 1.35; la versión 1.37.0 se publicó el 26/08/2026. Este dato sirve para corregir la previsión anterior, pero no debe desplazar el estudio de la arquitectura y los objetos estables.

#### Fuentes oficiales de la ampliación

- [Kubernetes — Releases](https://kubernetes.io/releases/) · ramas menores activamente soportadas
- [Kubernetes 1.37](https://kubernetes.io/releases/1.37/) · fecha y estado de la serie 1.37

> **Alcance de estudio:** No memorices números de parche. Comprueba la versión soportada solo cuando una pregunta o supuesto dependa expresamente de actualidad.

<!-- editorial-supplement:B2-T07:01:end -->
...
Las ramas soportadas de Kubernetes cambian con el calendario del proyecto. Para examen deben priorizarse objetos, responsabilidades y arquitectura estable, utilizando la página oficial de versiones para cualquier dato temporal.
