...
Fuente: [02 — BLOQUE II — Tecnología básica — GSI A2](https://docs.google.com/document/d/1_-6JFktfHXhth_n3KeUfRPjPeFxp3Mgkl2HlZzab7c4/edit) · II.07 · V2.1 · 2026-09-23
...
### Kubernetes: control plane, nodos y objetos

![Arquitectura de Kubernetes con API Server, scheduler, controller manager y almacén de estado en el control plane, y nodos con kubelet, runtime, pods y Services que proporcionan acceso estable.](../../assets/diagrams/b2/b2-t07-kubernetes.svg)

_Separa componentes del clúster de los objetos declarativos que gestiona el usuario._

**Qué debes recordar:** El control plane reconcilia estado deseado; el Pod es la unidad de despliegue y el Service ofrece acceso estable, pero no es un microservicio de negocio.
