...
Fuente: [03 — BLOQUE III — Desarrollo de sistemas — GSI A2](https://docs.google.com/document/d/1T28bNfTrftG0eCG2sX336DKKir-8ruVKnkhKMS0w7N0/edit) · III.11 · V2.1 · 2026-09-23
...
.NET 10 es la versión LTS de referencia en esta revisión y tiene soporte previsto hasta noviembre de 2028. La elección de versión debe considerar compatibilidad y ciclo de soporte; las fechas próximas a caducar se consultan en la política oficial vigente.
...
### Plataforma .NET moderna de extremo a extremo

![Arquitectura desde C sharp y el SDK hacia IL y CLR, ASP.NET Core con middleware e inyección, servicios, Entity Framework Core o ADO.NET, identidad, observabilidad y despliegue framework-dependent o self-contained.](../../assets/diagrams/b3/b3-t11-dotnet.svg)

_Relaciona herramientas, runtime, modelo web, persistencia, seguridad y despliegue._

**Qué debes recordar:** CLR ejecuta IL administrado; ASP.NET Core compone la aplicación y EF Core es un ORM, no el runtime ni la base de datos.
...
La política de soporte distingue versiones LTS y STS. Para versiones con vencimiento próximo, comprueba la fecha vigente en la documentación oficial antes de usarla en un supuesto.
