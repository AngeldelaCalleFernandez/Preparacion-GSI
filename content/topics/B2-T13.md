...
Fuente: [02 — BLOQUE II — Tecnología básica — GSI A2](https://docs.google.com/document/d/1_-6JFktfHXhth_n3KeUfRPjPeFxp3Mgkl2HlZzab7c4/edit) · II.13 · V2.1 · 2026-09-23

## 1. Alcance y fuentes

Seguridad preventiva y detectiva, respuesta a incidentes e informática forense deben estudiarse como un continuo: proteger, detectar, contener, recuperar, preservar evidencia y aprender.
...
<!-- editorial-supplement:B2-T13:01:start -->

### FAR, FRR y EER en biometría

FAR (False Acceptance Rate) mide falsas aceptaciones y FRR (False Rejection Rate), falsos rechazos. EER (Equal Error Rate) es el punto en que FAR y FRR se igualan para un umbral; en general, un EER menor indica mejor comportamiento comparativo, no una garantía absoluta de seguridad.

<!-- editorial-supplement:B2-T13:01:end -->
...
<!-- editorial-supplement:B2-T13:02:start -->

### Vishing

Vishing (voice phishing) es phishing mediante llamadas o comunicaciones de voz. Se distingue del smishing, realizado por SMS o mensajería de texto.

<!-- editorial-supplement:B2-T13:02:end -->
...
![Ciclo desde preparación, detección y análisis hacia contención, erradicación, recuperación y lecciones aprendidas, con una vía paralela de identificación, preservación, adquisición, hash y cadena de custodia.](../../assets/diagrams/b2/b2-t13-incidente-forense.svg)

_Integra la respuesta operativa con la conservación de evidencia, dos objetivos que deben coordinarse._

**Qué debes recordar:** Contener no es erradicar; la urgencia operativa debe equilibrarse con preservar evidencia íntegra y trazable.
