...
Fuente: [03 — BLOQUE III — Desarrollo de sistemas — GSI A2](https://docs.google.com/document/d/1T28bNfTrftG0eCG2sX336DKKir-8ruVKnkhKMS0w7N0/edit) · III.05 · V2.1 · 2026-09-23
...
### Del problema al algoritmo y al modelo de IA

![Mapa de decisión que conecta operaciones y restricciones con estructuras de datos, estrategias como divide y vencerás, voraz, programación dinámica y backtracking, y el ciclo de datos, entrenamiento, evaluación e inferencia de IA.](../../assets/diagrams/b3/b3-t05-algoritmos-ia.svg)

_Evita mezclar abstracción de datos, técnica algorítmica y aprendizaje automático._

**Qué debes recordar:** Primero define problema, operaciones y métricas; después elige estructura, algoritmo o modelo, y valida su coste y generalización.


Las estrategias de diseño explican cómo abordar el problema; la estructura de datos y la complejidad determinan el coste de las operaciones que la solución necesita.
